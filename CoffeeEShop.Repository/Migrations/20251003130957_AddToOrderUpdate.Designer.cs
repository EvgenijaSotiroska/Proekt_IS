...
namespace CoffeeEShop.Repository.Migrations
{
    ...
    [Migration("20251003130957_AddToOrderUpdate")]
    partial class AddToOrderUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoffeeEShop.Domain.DomainModels.DetailedProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("CaffeineInfo")
                        .IsRequired()
            ...
            modelBuilder.Entity("CoffeeEShop.Domain.DomainModels.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CoffeeEShop.Domain.DomainModels.ProductInCoffeeShop", b =>
                {
                    ...
                    b.ToTable("ProductInCoffeeShops");
                });

            modelBuilder.Entity("CoffeeEShop.Domain.DomainModels.ProductInOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CoffeeEShop.Domain.DomainModels.ProductInCoffeeShop", b =>
                {
                    ...
                    b.HasOne("CoffeeEShop.Domain.DomainModels.Product", "Product")
                        .WithMany("AllCoffeeShops")
            ...
            modelBuilder.Entity("CoffeeEShop.Domain.DomainModels.ProductInOrder", b =>
                {
                    b.HasOne("CoffeeEShop.Domain.DomainModels.Order", "Order")
                        .WithMany("AllProducts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CoffeeEShop.Domain.Identity.SystemUser", null)
                        .WithMany()
