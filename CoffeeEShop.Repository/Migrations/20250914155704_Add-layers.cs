        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserOrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "ProductInCoffeeShops",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CoffeeShopId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductInCoffeeShops", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductInCoffeeShops_CoffeeShops_CoffeeShopId",
                        column: x => x.CoffeeShopId,
                        principalTable: "CoffeeShops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductInCoffeeShops_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductInCoffeeShops_CoffeeShopId",
                table: "ProductInCoffeeShops",
                column: "CoffeeShopId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductInCoffeeShops_ProductId",
                table: "ProductInCoffeeShops",
                column: "ProductId");
